...
# PATHS
# =============================================================================
ENTITY_CACHE_PATH = Path(__file__).resolve().parent.parent / "entity_cache.json"
...
STOPWORDS = {normalize_greek(w) for w in {
    ...
    # Verbs / copulas that can false-match entity names (e.g. "είναι" → "ENAIRE")
    "ειναι", "είναι", "ηταν", "ήταν", "εστω", "έστω",
    # Question words that must never match entities
    "τι", "ποιο", "ποια", "ποιοι", "ποιοιε", "ποιου", "ποιων",
    "συνολικη", "συνολική", "συνολικο", "συνολικό", "αξια", "αξία"
}}
# =============================================================================
