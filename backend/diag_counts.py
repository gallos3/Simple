...
def check_counts():
    ...
    q2 = "MATCH (a:Award) WHERE substring(a.signed_date, 0, 4) = '2024' RETURN count(a) as cnt"
    # 3. Awards for Athens in 2024
    q3 = "MATCH (b:Buyer {name: 'Δήμος Αθηναίων'})-[:AWARDS]->(a:Award) WHERE substring(a.signed_date, 0, 4) = '2024' RETURN count(a) as cnt"
