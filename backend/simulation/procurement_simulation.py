...
FALLBACK_SYSTEM_PROMPT_START = (
    ...
    "4. You MAY include fictional authorities, fictional procurement needs, fictional supplier interactions, fictional budgets, and generic dilemmas.\n"
    ...
    "[SOURCE STATUS]\n"
    "This scenario is a generic training exercise and does not rely on a specific legal source excerpt.\n\n"
    "[CHALLENGE]\n"
    "One practical training question (e.g., managing risk, balancing transparency). Do NOT ask if it is legal or compliant.\n\n"
    "[OPTIONS]\n"
    "Provide exactly three options:\n"
    "A. ...\nB. ...\nC. ...\n\n"
    "[LEARNING FOCUS]\n"
    "Provide learning focus for exactly the same three options A, B, and C:\n"
    "A. Practical reasoning exercise.\n"
    "B. Practical reasoning exercise.\n"
    "C. Practical reasoning exercise.\n\n"
    "[FEEDBACK RULE]\n"
    "Feedback will evaluate reasoning quality only, not legal correctness.\n\n"
    "[LIMITATION]\n"
    "This is a generic educational procurement scenario. It is not legal advice and does not constitute a final legal assessment."
)
...
FALLBACK_SYSTEM_PROMPT_CONTINUE = (
    ...
    "5. The number of options and the number of learning focuses must match exactly.\n"
    "6. Do NOT ask whether something is legally compliant. Instead, ask practical risk management questions.\n\n"
    "OUTPUT FORMAT (strictly follow this layout):\n"
    "[SIMULATION MODE]\n"
    "Training Mode — Generic Educational Scenario\n\n"
    "[YOUR CHOICE]\n"
